...
public class ComentarioControlador {
	...
	public ResponseEntity<ComentarioDTO> actualizarComentario(@Valid @PathVariable(value = "publicacionId")Long publicacionId,@PathVariable(value = "id")Long comentarioId,@Valid @RequestBody ComentarioDTO comentarioDTO){
